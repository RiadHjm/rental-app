...
const Drawer = ({ vehicleAvailable }) => {
    return (
        <>
            <div class="text-center">
                <button className={`text-white ${vehicleAvailable ? 'bg-blueLogo hover:bg-silverGrey' : 'bg-silverGrey pointer-events-none'} font-medium rounded-lg text-sm px-5 py-2.5 text-center ${vehicleAvailable ? 'dark:bg-blueLogo dark:hover:bg-silverGrey' : 'dark:bg-silverGrey'} duration-300`} type="button" data-drawer-target="drawer-contact" data-drawer-show="drawer-contact" aria-controls="drawer-contact">
                    Rent Car
                </button>
            </div>
